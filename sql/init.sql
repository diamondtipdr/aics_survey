...
CREATE TABLE IF NOT EXISTS aics_leads (
    ...
    ai_report       TEXT            DEFAULT NULL COMMENT 'Full AI diagnostic report text',
    created_at      TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    processed       BOOLEAN         DEFAULT FALSE COMMENT 'Consumed by the external system (e.g. Moodle)?',
...
-- Query example for external systems:
